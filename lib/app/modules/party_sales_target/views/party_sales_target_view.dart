  ...
  class PartySalesTargetView extends StatefulWidget {
    const PartySalesTargetView({super.key});

    @override
    _PartySalesTargetScreenState createState() => _PartySalesTargetScreenState();
  }

  class _PartySalesTargetScreenState extends State<PartySalesTargetView> {
